<?php 
 ...
 <table>
	...
	<tbody>
		...
		$sql = mysql_query("SELECT products.id, products.product_name, transactions.mc_fee, transactions.qty, transactions.payment_date
FROM transactions
INNER JOIN products ON products.id = transactions.product_id_array");
