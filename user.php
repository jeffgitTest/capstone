  ...
  <div class="modal-dialog">
	...
	$product_array = $row["product_id_array"];
               ...
               <div class="col-lg-3" style="font-size: 14px">'.$prod_name2.'</div>
                <div class="col-lg-3" style="font-size: 14px"> &#8369;'.number_format($price2, 2, '.', ',').'</div>
                 <div class="col-lg-3" style="font-size: 14px">'.$quan.'</div>
                 <div class="col-lg-3" style="font-size: 14px">&#8369;'.number_format($pricetotal1, 2, '.', ',').'</div>
             </div>';
